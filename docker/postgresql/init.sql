...
\c torganizer
--
CREATE TABLE _RESTRICTIONS (_ID  SERIAL NOT NULL, DTYPE VARCHAR(31), PRIMARY KEY (_ID));
CREATE TABLE _OPPONENT_TYPE_RESTRICTIONS (_ID BIGINT NOT NULL, _OPPONENT_TYPE VARCHAR(255), PRIMARY KEY (_ID));
CREATE TABLE _OPPONENTS (_ID  SERIAL NOT NULL, DTYPE VARCHAR(31), _STATUS VARCHAR(255) NOT NULL, PRIMARY KEY (_ID));
...
CREATE TABLE _PERSONS (_ID  SERIAL NOT NULL, _DATE_OF_BIRTH VARCHAR(255), _FIRST_NAME VARCHAR(255), _GENDER VARCHAR(255) NOT NULL, _LAST_NAME VARCHAR(255), PRIMARY KEY (_ID));
...
CREATE TABLE _GYMNASIUMS (_ID  SERIAL NOT NULL, _NAME VARCHAR(255) NOT NULL, PRIMARY KEY (_ID));
CREATE TABLE _CLUBS (_ID  SERIAL NOT NULL, _NAME VARCHAR(255) NOT NULL, PRIMARY KEY (_ID));
CREATE TABLE _GROUPS (_ID  SERIAL NOT NULL, _POSITION INTEGER, PRIMARY KEY (_ID));
CREATE TABLE _POSITIONAL_OPPONENTS (_ID  SERIAL NOT NULL, _POSITION INTEGER NOT NULL, _OPPONENT_ID BIGINT NOT NULL, PRIMARY KEY (_ID));
CREATE TABLE _MATCHES (_ID  SERIAL NOT NULL, _FINISHED_TIME VARCHAR(255), _POSITION INTEGER NOT NULL, _RUNNING BOOLEAN NOT NULL, _GUEST_ID BIGINT, _HOME_ID BIGINT, PRIMARY KEY (_ID));
CREATE TABLE _GENDER_RESTRICTIONS (_ID BIGINT NOT NULL, _GENDER VARCHAR(255) NOT NULL, PRIMARY KEY (_ID));
CREATE TABLE _COURTS (_ID  SERIAL NOT NULL, _NR INTEGER NOT NULL, _MATCH_ID BIGINT, PRIMARY KEY (_ID));
CREATE TABLE _ROUNDS (_ID  SERIAL NOT NULL, _POSITION INTEGER, _QUALIFIED INTEGER, _SYSTEM VARCHAR(255) NOT NULL, PRIMARY KEY (_ID));
CREATE TABLE _DISCIPLINES (_ID  SERIAL NOT NULL, _NAME VARCHAR(255) NOT NULL, PRIMARY KEY (_ID));
CREATE TABLE _UNKNOWNS (_ID BIGINT NOT NULL, PRIMARY KEY (_ID));
CREATE TABLE _TOURNAMENTS (_ID  SERIAL NOT NULL, _NAME VARCHAR(255), PRIMARY KEY (_ID));
CREATE TABLE _RESULTS (_ID  SERIAL NOT NULL, _GUEST_SCORE INTEGER NOT NULL, _HOME_SCORE INTEGER NOT NULL, _POSITION INTEGER NOT NULL, PRIMARY KEY (_ID));
...
-- sample data
-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
INSERT INTO _TOURNAMENTS (_ID, _NAME) VALUES (1, 'Beispiel');

INSERT INTO _CLUBS (_ID, _NAME) VALUES (1, 'TuS Ickern');
INSERT INTO _CLUBS (_ID, _NAME) VALUES (2, 'TB Rauxel');
INSERT INTO _CLUBS (_ID, _NAME) VALUES (3, 'CTV');
INSERT INTO _CLUBS (_ID, _NAME) VALUES (4, 'HKC');

INSERT INTO _PERSONS (_ID, _DATE_OF_BIRTH, _FIRST_NAME, _LAST_NAME, _GENDER) VALUES (1, '2011-11-30', 'A-Firstname', 'A-Lastname', 'MALE');
INSERT INTO _OPPONENTS (_ID, _STATUS, DTYPE) VALUES (1, 'ACTIVE', 'Player');
...
INSERT INTO _PERSONS (_ID, _DATE_OF_BIRTH, _FIRST_NAME, _LAST_NAME, _GENDER) VALUES (2, '2011-10-30', 'B-Firstname', 'B-Lastname', 'MALE');
INSERT INTO _OPPONENTS (_ID, _STATUS, DTYPE) VALUES (2, 'ACTIVE', 'Player');
...
INSERT INTO _PERSONS (_ID, _DATE_OF_BIRTH, _FIRST_NAME, _LAST_NAME, _GENDER) VALUES (3, '2011-09-30', 'C-Firstname', 'C-Lastname', 'MALE');
INSERT INTO _OPPONENTS (_ID, _STATUS, DTYPE) VALUES (3, 'ACTIVE', 'Player');
...
INSERT INTO _PERSONS (_ID, _DATE_OF_BIRTH, _FIRST_NAME, _LAST_NAME, _GENDER) VALUES (4, '2011-08-30', 'D-Firstname', 'D-Lastname', 'MALE');
INSERT INTO _OPPONENTS (_ID, _STATUS, DTYPE) VALUES (4, 'ACTIVE', 'Player');
...
INSERT INTO _PERSONS (_ID, _DATE_OF_BIRTH, _FIRST_NAME, _LAST_NAME, _GENDER) VALUES (5, '2011-07-30', 'E-Firstname', 'E-Lastname', 'MALE');
INSERT INTO _OPPONENTS (_ID, _STATUS, DTYPE) VALUES (5, 'ACTIVE', 'Player');
...
INSERT INTO _PERSONS (_ID, _DATE_OF_BIRTH, _FIRST_NAME, _LAST_NAME, _GENDER) VALUES (6, '2011-06-30', 'F-Firstname', 'F-Lastname', 'MALE');
INSERT INTO _OPPONENTS (_ID, _STATUS, DTYPE) VALUES (6, 'ACTIVE', 'Player');
...
INSERT INTO _PERSONS (_ID, _DATE_OF_BIRTH, _FIRST_NAME, _LAST_NAME, _GENDER) VALUES (7, '2011-05-30', 'G-Firstname', 'G-Lastname', 'MALE');
INSERT INTO _OPPONENTS (_ID, _STATUS, DTYPE) VALUES (7, 'ACTIVE', 'Player');
...
INSERT INTO _PERSONS (_ID, _DATE_OF_BIRTH, _FIRST_NAME, _LAST_NAME, _GENDER) VALUES (8, '2011-04-30', 'H-Firstname', 'H-Lastname', 'MALE');
INSERT INTO _OPPONENTS (_ID, _STATUS, DTYPE) VALUES (8, 'ACTIVE', 'Player');
...
INSERT INTO _PERSONS (_ID, _DATE_OF_BIRTH, _FIRST_NAME, _LAST_NAME, _GENDER) VALUES (9, '2011-09-30', 'I-Firstname', 'I-Lastname', 'MALE');
INSERT INTO _OPPONENTS (_ID, _STATUS, DTYPE) VALUES (9, 'ACTIVE', 'Player');
...
INSERT INTO _PERSONS (_ID, _DATE_OF_BIRTH, _FIRST_NAME, _LAST_NAME, _GENDER) VALUES (10, '2011-09-30', 'J-Firstname', 'J-Lastname', 'MALE');
INSERT INTO _OPPONENTS (_ID, _STATUS, DTYPE) VALUES (10, 'ACTIVE', 'Player');
...
INSERT INTO _PERSONS (_ID, _DATE_OF_BIRTH, _FIRST_NAME, _LAST_NAME, _GENDER) VALUES (11, '2011-09-30', 'K-Firstname', 'K-Lastname', 'MALE');
INSERT INTO _OPPONENTS (_ID, _STATUS, DTYPE) VALUES (11, 'ACTIVE', 'Player');
...
INSERT INTO _PERSONS (_ID, _DATE_OF_BIRTH, _FIRST_NAME, _LAST_NAME, _GENDER) VALUES (12, '2011-09-30', 'L-Firstname', 'L-Lastname', 'MALE');
INSERT INTO _OPPONENTS (_ID, _STATUS, DTYPE) VALUES (12, 'ACTIVE', 'Player');
...
INSERT INTO _DISCIPLINES (_ID, _NAME) VALUES (1, 'HE-A');
INSERT INTO _RESTRICTIONS (_ID, DTYPE) VALUES (1, 'AgeRestriction');
INSERT INTO _RESTRICTIONS (_ID, DTYPE) VALUES(2, 'GenderRestriction');
INSERT INTO _RESTRICTIONS (_ID, DTYPE) VALUES(3, 'OpponentTypeRestriction');
