...
public class SwitchOpponent implements Serializable {
  ...
  public void setSwitchSource() {
    ...
    System.out.println("setSwapSource: " + sourceGroupId + " / " + sourceOpponentId);
  }
  ...
  public void switchWith() {
    ...
    System.out.println("swapWith: " + sourceGroupId + "/" + sourceOpponentId + " with " + targetGroupId + "/" + targetOpponentId);
  }
}
