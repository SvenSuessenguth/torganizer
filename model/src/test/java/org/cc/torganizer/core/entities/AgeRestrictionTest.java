...
public class AgeRestrictionTest {
	...
	private static Stream<Arguments> addRestrictionAndPlayer(){
		...
		return Stream.of(
			...
			Arguments.of(
				new AgeRestriction(
					    localDateFactory(2010, 1, 1),
					    localDateFactory(2009, 1, 1)),
				playerFactory(2009, 1, 2),
				FALSE),
      ...
      // zu jung (einen Tag)
			...
			Arguments.of(
				new AgeRestriction(
					localDateFactory(2010, 1, 1),
					localDateFactory(null, null, null)),
				playerFactory(2009, 1, 1),
				FALSE)
		);
	}
