...
public class AggregationComparator
  ...
  public final int compare(final Aggregation o1, final Aggregation o2) {
    ...
    if (Checker.isNoNullValue(o1.getMa(), o2.getMa())
      && !o1.getMa().equals(o2.getMa())) {
      result = o1.getMa().getRatio().compareTo(o2.getMa().getRatio());
    } else if (Checker.isNoNullValue(o1.getRa(), o2.getRa())
      && !o1.getRa().equals(o2.getRa())) {
      result = o1.getRa().getRatio().compareTo(o2.getRa().getRatio());
    } else if (Checker.isNoNullValue(o1.getSa(), o2.getSa())
      && !o1.getSa().equals(o2.getSa())) {
