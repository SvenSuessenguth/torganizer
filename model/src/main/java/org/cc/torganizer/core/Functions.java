...
/**
 * Allgemeine Funktionen, die aus der View verwendetwerden koennen.
 *
 * @author svens
 *     $LastChangedBy: u000349 $
 *     $Rev: 1277 $
 *     $LastChangedDate: 2015-05-03 06:47:10 +0200 (So, 03 Mai 2015) $
 */
public final class Functions {
   ...
   */
  public static int getPot(int exponent) {
   ...
   */
  public static Match getMatchByIndex(Group group, int matchIndex) {
    if (group == null) {
      return null;
    }
   ...
   */
  public static Opponent getOpponentByIndex(Group group, int opponentIndex) {
    if (group == null) {
      return null;
    }
   ...
   * @return Gewinner
   */
  public static Opponent winner(Match match) {
  ...
  public static List<Result> results(Match match) {
